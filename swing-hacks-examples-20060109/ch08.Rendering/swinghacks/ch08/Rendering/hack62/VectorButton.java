...
public class VectorButton extends JButton implements MouseListener {
	...
	protected void drawDropShadow(int w, int h, float scale, Graphics2D g2) {
		...
		this.fillRoundRect(g2, (-.04f) * scale, (.02f) * scale, w + .08f * scale, h + 0.08f * scale, scale * 1.04f, scale * 1.04f);
	...
	protected void drawButtonBody(int w, int h, float scale, Color base, Graphics2D g2) {
		...
		g2.setColor(inner);
		this.fillRoundRect(g2, scale * (.4f), scale * (.4f), w - scale * .8f, h - scale * .5f, scale * .6f, scale * .4f);
	}
	...
	protected void drawHighlight(int w, int h, float scale, Color base, Graphics2D g2) {
		...
		GradientPaint highlight = new GradientPaint(new Point2D.Float(scale * 0.2f, scale * 0.2f), new Color(255, 255, 255, 175), new Point2D.Float(scale * 0.2f, scale * 0.55f), new Color(255, 255,
				255, 0));
